...
#PLayer{
    width:100%;
    height:100%;
    background:linear-gradient(top,#5c6767,#422f32);
    overflow:hidden;
}
.Player-top{
    width:100%;
    height:$Player-100;
    margin-top:$Player-10;
    ...
    >li{
        float:left;
    >i{
        font-size: $Player-100/2;
        color:white;
        line-height:$Player-100;
        padding-left:$Player-10*3;
        padding-right:$Player-10*3;
      }
     }
    }
}
.Player-middle{
    height:$Player-100*6.8;
    width:100%;
    .Player-Record{
        width:$Player-100*5;
        height:$Player-100*5;
        margin:0px auto;
        margin-top:$Player-100*1.6;
        border-radius:50%;
        background:#76766e;
        overflow:hidden;
        padding:$Player-10;
